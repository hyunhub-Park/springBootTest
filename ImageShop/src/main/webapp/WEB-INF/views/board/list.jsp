...
<body>
	...
	<div align="center">
		...
		<form:form modelAttribute="pgrq" method="get"
			action="list${pgrq.toUriStringByPage(pgrq.page)}&searchType=${pgrq.searchType}&keyword=${pgrq.keyword}">
		...
		<div>
			...
			<c:forEach begin="${pagination.startPage }"
				...
				<a
					href="/board/list${pagination.makeQuery(idx)}&searchType=${pgrq.searchType}&keyword=${pgrq.keyword}">${idx}</a>
			</c:forEach>
